/* eslint-disable react-refresh/only-export-components -- buttonVariants exported for styling API */
...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary:
          'bg-[var(--primary)]! text-[var(--primary-foreground)]! hover:bg-[var(--primary-hover)]! data-[state=open]:bg-[var(--primary-hover)]!',
      ...
      size: {
        ...
        xs: 'h-8.5 rounded-md px-2.5 gap-1 text-xs [&_svg:not([class*=size-])]:size-3.5',
