...
/* eslint-disable react-refresh/only-export-components -- textareaVariants exported for styling API */
...
const textareaVariants = cva(
  `
    w-full bg-card border border-input text-foreground shadow-xs shadow-black/5 transition-[color,box-shadow]
