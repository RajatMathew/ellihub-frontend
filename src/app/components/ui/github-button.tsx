...
/* eslint-disable react-refresh/only-export-components -- githubButtonVariants and types exported for API */
/* eslint-disable react-hooks/set-state-in-effect -- derived animation state sync from props */
